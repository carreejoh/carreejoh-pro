...
const Homepage: React.FC = () => {
  return (
    ...
    <>
      ...
      <Helmet>
        <title>RevUpWeb | Quick beautiful websites for local businesses</title>
        <meta
          name="description"
          content="We build beautiful, mobile-friendly websites for small businesses. Fast turnaround. Affordable pricing. Get online quickly and professionally."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Quick, Beautiful Websites for Local Businesses" />
        <meta
          property="og:description"
          content="Clean, responsive websites built quickly for small business owners. Affordable and effective."
        />
        <meta property="og:type" content="website" />
        {/* <meta property="og:url" content="https://yourdomain.com/" />
        <meta property="og:image" content="https://yourdomain.com/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Get Your Business Online Fast" />
        <meta name="twitter:description" content="Clean, responsive websites built quickly for small business owners." />
